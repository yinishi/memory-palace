...
app.directive('threeModel', ['textFactory', 'palacesFactory','$window', 'roomFactory', 'objectFactory', 'shelfFactory', '$document', 'storingFactory', 'modalFactory', require("./threeModel")]);

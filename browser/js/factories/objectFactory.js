...
function load (link, scale, name, message) {
  ...
  var factory = {
    getObjects : function(){
     return [
        {name: 'teapot', image: "./browser/images/teapot.png", scale: .3, yPosition: 2},
        ...
        {name: 'candy', image: "./browser/images/candy.png", scale: 2},
        {name: 'flower', image: "./browser/images/flower.png", scale: .2, yPosition: 1},
        ...
        {name: 'mug', image: "./browser/images/mug.png", scale: .1, yPosition: 5},  
        {name: 'cat-mug', image: "./browser/images/cat-mug.png", scale: 3, yPosition: 5},    
        {name: 'pink-bed', image: "./browser/images/pink-bed.png", scale: 17, yPosition: 3},
        {name: 'bed', image: "./browser/images/bed.png", scale: 15, yPosition: 7},
        {name: 'chair', image: "./browser/images/chair.png", scale: 15},
        ...
        {name: 'soccer-ball', image: "./browser/images/soccer-ball.png", scale: .07, yPosition: 4},
        {name: 'nike', image: "./browser/images/nike.png", scale: .5},
        {name: 'toy-train', image: "./browser/images/toy-train.png", scale:2, yPosition: 1},
